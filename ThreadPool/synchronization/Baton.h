...
#include "synchronization/detail/Spin.h"
...
///
    ...
    public:
        ...
        void post() noexcept {
            ...
            folly::detail::futexWake(&state_, 1);
        }
    ...
    private:
        ...
        FOLLY_NOINLINE bool tryWaitSlow(
            ...
            while (true) {
                auto rv = folly::detail::MemoryIdler::futexWaitUntil(state_, WAITING, deadline);
        ...
        folly::detail::Futex<Atom> state_;
    };
